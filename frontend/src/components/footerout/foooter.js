      ...
      <Container>
        <Row>
          ...
          <Col xs={5}>
            <ul>
              <li>
                <a href="https://ta.sdaia.gov.sa/en/TawakkalnaEn.pdf" />
                User Guide
              </li>
              <li>
                <Link to="https://ta.sdaia.gov.sa/en/privacy-en.html" /> Privacy
                Policy
              </li>
              <li>
                {" "}
                <a href="https://ta.sdaia.gov.sa/en/terms-en.html" /> Terms and
                Conditions
              </li>
            </ul>
          </Col>
        ...
        <Row>
          ...
          <Col xs={5} style={{ fontSize: "20px" }}>
            © All rights reserved, SDAIA, 2021
          </Col>
          <Col></Col>
        </Row>
      </Container>
